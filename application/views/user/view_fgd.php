          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"> <!-- General Body -->
              <div class="menu_section">
                ...
                <!-- Corporate-->
                <li><a href="<?php echo base_url();?>Asessment_dedy"><i class="fa fa-edit active"></i> Assesment <span class=""></span></a>
                </li>
                <!-- End Corporate-->
              ...
              <div class="">
                <div class="page-title">
                  <div class="title_left">
                    <h3><strong> Forum Group Discussion </strong>Culture Assessment<!-- <small> Formulir asessment  <strong> karyawan </strong></small> --></h3>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="x_panel">
                ...
                <div class="x-content">
                    <form method="POST" action="<?php echo base_url();?>isna/nilai_fgd" role="form">
                        ...
                        <!-- <table class="table table-striped table-bordered table-hover dataTables-example" > -->
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 7%;" >
                                        <h5><center>Agak Tidak Setuju</center></h5>
                                    </th>
                                    <th style="width: 7%;">
                                        <h5><center>Agak Setuju</center></h5>
                                    </th>
                                    <th style="width: 7%;">
                                        <h5><center>Setuju</center></h5>
                                    </th>
                                    <th style="width: 7%;">

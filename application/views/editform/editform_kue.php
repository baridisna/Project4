                ...
                <tbody>
                    ...
                    foreach ($pertanyaan as $p){
                        echo "<tr>
                            ...
                            <td ><center>".anchor('editform/edit_kue/'.$p->id_kuesioner,'<span class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</span>')."</center></td>
                            <td ><center>".anchor('editform/delete_kue/'.$p->id_kuesioner,'<span class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </span>')."</center></td>
                            </tr>";
                    }
                    ?>
<!-- comment buat yang tombol edit <td ><center><button class='btn btn-success btn-sm pull-right aphp' type='button'  data-toggle='modal' data-target='.bs-example-modal-sm'><i class='fa fa-pencil'></i> Edit</center></td> -->
                    <tr>
                    <td colspan="5"  >
...
<!-- modalnya -->
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo anchor('admin/edit_kuesioner','KEMBALI');?></button>
  ...
  <!-- end modal -->
                    ...
                    <!-- <button class="btn btn-info btn-sm pull-right aphp " type="button"  data-toggle="tooltip" data-placement="bottom" title="Lihat form">
                         <?php //echo anchor('index.php/kuesioner/preview_kue','Preview <i class="fa fa-eye fa-2x"> </i> '); ?>
                    </button> -->
                    </td> </tr>
                </tbody>
            </table>
...
<!-- coba coba-->
<!-- <button class="btn btn-success btn-sm pull-right aphp " type="button"  data-toggle="modal" data-target=".bs-example-modal-sm" title="Tambah pertanyaan">
                       Add <i class="fa fa-plus-circle fa-2x"> </i>
                    </button> -->

<!-- <td ><center>".anchor('editform/edit_kue/'.$p->id_kuesioner,'<span class="btn btn-info btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg" title="Tambah pertanyaan"><i class="fa fa-pencil"></i> Edit</span>')."</center></td> -->
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">Edit Pertanyaan</h4>
                          <?php echo form_open('editform/edit_simpan_kue'); ?>

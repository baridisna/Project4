              ...
              <div class="">
                <div class="page-title">
                  <div class="title_left">
                    <h3><strong> Interview </strong>Culture Assessment<!-- <small> Formulir asessment  <strong> karyawan </strong></small> --></h3>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="x_panel">
                ...
                <div class="x-content">
                    <form method="POST" action="<?php echo base_url();?>isna/nilai_interview" role="form">

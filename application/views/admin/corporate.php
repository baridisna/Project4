          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> <!-- angka 12 di md san sm itu menentukan panjang cardnya sedangkan 12 di xs lebar cardnya -->
              <div class="dashboard_graph">
                ...
                <div class="">
                  <div class="col-md-6">
                    <h3>CORPORATE <small></small></h3> <!-- diantara <small> ini bisa di isi teks -->
                  </div>
                </div>
		  ...
		  <div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barcorporate" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugecorporate" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barcorporate2" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugecorporate2" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barcorporate3" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugecorporate3" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barcorporate4" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugecorporate4" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barcorporate5" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugecorporate5" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			   <!-- batas akhir chart kelima -->
			     ...
			     <div class="col-md-12">
                        <div class="panel panel-body">
                          ...
                          <p>Berikut ini merupakan tiga direktorat yang menempati di posisi tiga teratas</p>
					  ...
					  <div class="col-md-12">
                        <div class="panel panel-body">
                          ...
                          <p>Berikut ini merupakan tiga direktorat yang menempati di posisi tiga terbawah</p>
                          <div class="row">
                            <div class="col-xs-4">
                              <span class="chart" data-percent="86">
                                              <span class="percent"></span>
